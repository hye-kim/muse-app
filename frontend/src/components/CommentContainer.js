      ...
      <div className="comment-container">
        ...
        <div>
          <div className="voting">
            <div className={`upvote ${hasUpvoted ? "has-upvoted" : ""}`} onClick={() => handleVote("upvote")}>
              <svg
                src="thumbs_up.svg"
            ...
            <div className={`downvote ${hasDownvoted ? "has-downvoted" : ""}`} onClick={() => handleVote("downvote")}>
              <svg
                src="thumbs_down.svg"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 21.62 21.36"
